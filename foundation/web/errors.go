...
// FieldError is used to indicate an error with specific request field.
...
// NewRewuestError wraps a provided error with an HTTP status code. This
...
// wrapped error. This is what will be shown in the services' log.
