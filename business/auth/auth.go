...
// This are the expected values for Claims.Roles.
const (
	RoleAdmin = "ADMIN"
	RoleUser  = "USER"
)
...
// Authorize returns true if the claims has at least one of provided roles.
...
// public key by KID.
//
// * KID to public key resolution is usualy accomplished via a public JWKS
